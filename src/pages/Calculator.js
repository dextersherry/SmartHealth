  ...
  return (
    <Box >
        <div className="container bmi-box">
            ...
            <TextField
            height="76px"
            sx={{ input: { fontWeight: '700', border: 'none', borderRadius: '4px', color:'Black'  },mt:{xs:"20px",lg:"20px"}, width: { lg: '500px', xs: '600px' }, backgroundColor: '#fff', borderRadius: '40px', mr:"20px" }}
            value={weight}
            ...
            <TextField
            height="76px"
            sx={{ input: { fontWeight: '700', border: 'none', borderRadius: '4px', color:'black' }, width: { lg: '500px', xs: '600px' }, mt:{xs:"20px",lg:"20px"}, backgroundColor: '#fff'  }}
            value={height}
        ...
        <Stack>
            <Typography sx={{ fontSize: { lg: '24px', xs: '18px' },ml:{xs:"70px"} }} color="black"  textAlign="center" variant="body2">
